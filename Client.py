...
class Client:
    ...
    def createWidgets(self):
        """Build GUI."""
        # Create Setup button
        self.setup_btn = PhotoImage(file='./set_up_btn.png')
        self.setup_btn_label = Label(image=self.setup_btn)
    
        self.setup = Button(self.master, image= self.setup_btn, borderwidth=3)
        ...
        self.start = Button(self.master, image= self.play_btn, borderwidth=3)
        ...
        self.pause = Button(self.master, image= self.pause_btn, borderwidth=3)
        ...
        self.teardown_btn_label = Label(image=self.teardown_btn)

        self.teardown = Button(self.master, image= self.teardown_btn, borderwidth=3)
